...
**Key findings:**
- No significant improvement in housing affordability (rent-to-income ratio: +0.22pp, p=0.21)
- Significant rent pass-through: **+$26.5/month per $1 MW increase** (p<0.001)
...
| 10. Heterogeneity | `heterogeneity.py` | Pass-through elasticity, subgroup effects by market tightness |
| 11. Figures | `make_figures.py` | Coefficient plots, event study plots, diagnostics |
...
│   ├── heterogeneity.py        # Pass-through & subgroup effects
